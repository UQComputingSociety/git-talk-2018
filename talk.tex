...
% \begin{frame}
%     \frametitle{Collaboration Work}

%     \begin{columns}
%         \begin{column}{0.5\textwidth}
%             \begin{itemize}
%                 \item<1-> Git is a \textbf{distributed} version control system
%                 \item<2-> Everyone has their own entire copy of the graph
%                 \item<3-> You can \textbf{push} your changes to a server
%                 \item<5-> You can \textbf{pull} changes you don't have from a server
%             \end{itemize}
%         \end{column}
%         \begin{column}{0.5\textwidth}
%             \only<1>{
...
%                         \node[green, circle, draw, minimum size=1cm] (F) at (6,-6) {git is cool};
%                         \draw[green, ->] (D) -- (F);
%                         \node[gray, dashed, circle, draw, minimum size=1cm] (G) at (4.5, -9) {merge};
%                         \draw[gray, dashed, ->] (E) -- (G);
%                         \draw[gray, dashed, ->] (F) -- (G);
%                     \end{tikzpicture}
%                 }
%             }
%             \only<2->{
...
%                         \draw[->] (B1) -- (D1);
%                         \node[blue, circle, draw, minimum size=1cm] (E1) at (3,-7) {dolor sit amet};
%                         \draw[blue, ->] (D1) -- (E1);

%                         \node[circle, draw, minimum size=1cm] (A2) at (6,0) {Hello};
%                         \node[circle, draw, minimum size=1cm] (B2) at (6,-2) {World};
%                         \draw[->] (A2) -- (B2);
%                         \node[gray, dashed, circle, draw, minimum size=1cm] (C2) at (6,-4) {F2iller Text};
%                         \draw[gray, dashed, ->] (B2) -- (C2);
%                         \node[circle, draw, minimum size=1cm] (D2) at (9,-4) {Lorem Ipsum};
%                         \draw[->] (B2) -- (D2);
%                         \node[green, circle, draw, minimum size=1cm] (F2) at (9,-7) {git is cool};
%                         \draw[green, ->] (D2) -- (F2);
%                         \only<3->{
%                             \node[circle, draw, minimum size=1cm] (A3) at (6,-8) {Hello};
%                             \node[circle, draw, minimum size=1cm] (B3) at (6,-10) {World};
%                             \draw[->] (A3) -- (B3);
%                             \node[gray, dashed, circle, draw, minimum size=1cm] (C3) at (6,-12) {Filler Text};
%                             \draw[gray, dashed, ->] (B3) -- (C3);
%                             \node[circle, draw, minimum size=1cm] (D3) at (9,-12) {Lorem Ipsum};
%                             \draw[->] (B3) -- (D3);
%                         }
%                         \only<4->{
%                             \node[blue, circle, draw, minimum size=1cm] (E3) at (9,-15) {dolor sit amet};
%                             \draw[blue, ->] (D3) -- (E3);
%                         }
%                         \only<4>{
%                             \draw[dashed, ->] (E1) -- (E3);
%                         }
%                         \only<6->{
%                             \node[blue, circle, draw, minimum size=1cm] (E2) at (12,-6) {dolor sit amet};
%                             \draw[blue, ->] (D2) -- (E2);
%                         }
%                         \only<6> {
%                             \draw[dashed, ->] (E3) -- (E2);
%                         }
%                         \only<7->{
%                             \node[circle, draw, minimum size=1cm] (G2) at (10.5,-9) {merge};
%                             \draw[->] (E2) -- (G2);
%                             \draw[->] (F2) -- (G2);
%                         }
%                     \end{tikzpicture}
